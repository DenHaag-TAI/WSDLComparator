...
public class AddedResult extends CompareResult {

	private String value;
	public AddedResult(){
	}
	public AddedResult(Compatibility compatibility, String prefix, String value){
		setCompatible(compatibility);
		setDescription(prefix);
		this.value = value;
	}
	public AddedResult(Compatibility compatible, String description, int value) {
	...
	public String toString() {
		String result = "ADDED: " + getDescription();
		if (value != null){
			result += " (" + value + ")";
		}
		return result;
