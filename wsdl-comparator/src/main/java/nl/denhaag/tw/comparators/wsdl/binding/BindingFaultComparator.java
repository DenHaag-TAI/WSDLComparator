...
public class BindingFaultComparator extends AbsItfBindingParamComparator<BindingFault> {

	public BindingFaultComparator(BindingFault oldObject, BindingFault newObject) {
